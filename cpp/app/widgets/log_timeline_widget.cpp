...
LogTimelineWidget::LogTimelineWidget(QWidget* parent) : QWidget(parent) {
    setMinimumSize(420, 200);
    setMouseTracking(false);
    setCursor(Qt::CrossCursor);
}

void LogTimelineWidget::set_config(const Config& cfg) {
    cfg_ = cfg;
...
void LogTimelineWidget::clear_config() {
    cfg_ = {};
    channel_ranges_.clear();
    cursor_idx_ = 0;
    view_start_ = 0;
...
void LogTimelineWidget::reset_zoom() {
...
void LogTimelineWidget::set_cursor_index(int idx) {
...
void LogTimelineWidget::paintEvent(QPaintEvent*) {
    QPainter p(this);
...
void LogTimelineWidget::mousePressEvent(QMouseEvent* e) {
...
void LogTimelineWidget::mouseMoveEvent(QMouseEvent* e) {
    if (zoom_drag_active_) {
...
void LogTimelineWidget::mouseReleaseEvent(QMouseEvent* e) {
...
void LogTimelineWidget::handle_seek(QMouseEvent* e) {
    if (cfg_.times.size() < 2) return;
    const int ml = 72, mr = 44;
    double pw = width() - ml - mr;
    if (pw <= 0) return;

...
DialGaugeWidget::DialGaugeWidget(const Config& cfg, QWidget* parent)
...
void DialGaugeWidget::mousePressEvent(QMouseEvent* ev) {
...
void DialGaugeWidget::contextMenuEvent(QContextMenuEvent* ev) {
...
void DialGaugeWidget::mouseMoveEvent(QMouseEvent* ev) {
...
void DialGaugeWidget::mouseReleaseEvent(QMouseEvent* ev) {
...
void DialGaugeWidget::dragEnterEvent(QDragEnterEvent* ev) {
...
void DialGaugeWidget::dropEvent(QDropEvent* ev) {
    auto from_id = ev->mimeData()->data("application/x-gauge-widget-id").toStdString();
...
void DialGaugeWidget::paintEvent(QPaintEvent*) {
    QPainter p(this);

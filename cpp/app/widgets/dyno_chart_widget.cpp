...
DynoChartWidget::DynoChartWidget(QWidget* parent) : QWidget(parent) {
    setMinimumSize(420, 240);
}

void DynoChartWidget::set_result(const tuner_core::virtual_dyno::DynoResult& r) {
    result_ = r;
    update();
}

void DynoChartWidget::clear_result() {
    result_ = {};
    update();
}

void DynoChartWidget::set_overlay(const tuner_core::virtual_dyno::DynoResult& r) {
    overlay_ = r;
    has_overlay_ = true;
    update();
}

void DynoChartWidget::clear_overlay() {
    overlay_ = {};
    has_overlay_ = false;
    update();
}

void DynoChartWidget::paintEvent(QPaintEvent*) {
    QPainter p(this);
